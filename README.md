...
* [Bit](https://github.com/teambit/bit) ⭐ 18,473 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-08 - A tool for developing and composing / integrating independently versioned components.
* [Project Mosaic](https://www.mosaic9.org/) - A set of services, libraries together with a specification by Zalando.

### Frameworks

* [Garfish](https://github.com/modern-js-dev/garfish) ⭐ 2,909 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-08 - A powerful micro front-end framework.
...
* [OpenComponents, a framework for developing and distributing html components](https://github.com/opencomponents/oc) ⭐ 1,473 | 🐛 42 | 🌐 JavaScript | 📅 2026-09-07
* [Isomorphic Layout Composer](https://github.com/namecheap/ilc) ⭐ 774 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-08 - Complete solution for Micro Frontends composition into SPA with SSR support.
...
* [NUT](https://github.com/nut-project/nut) ⭐ 110 | 🐛 27 | 🌐 HTML | 📅 2026-09-07
...
* [Micromono](https://github.com/lsm/micromono) ⭐ 637 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-26
