...
* [Bit](https://github.com/teambit/bit) ⭐ 18,483 | 🐛 70 | 🌐 TypeScript | 📅 2026-09-16 - A tool for developing and composing / integrating independently versioned components.
* [Project Mosaic](https://www.mosaic9.org/) - A set of services, libraries together with a specification by Zalando.

### Frameworks

* [Garfish](https://github.com/modern-js-dev/garfish) ⭐ 2,911 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-16 - A powerful micro front-end framework.
