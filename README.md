# Awesome Micro-Frontends with stars
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,457 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-21 - A tool for developing and composing / integrating independently versioned components.

### Frameworks

* [Garfish](https://github.com/modern-js-dev/garfish) ⭐ 2,908 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-21 - A powerful micro front-end framework.
...
* [OpenComponents, a framework for developing and distributing html components](https://github.com/opencomponents/oc) ⭐ 1,473 | 🐛 34 | 🌐 JavaScript | 📅 2026-08-20
* [Isomorphic Layout Composer](https://github.com/namecheap/ilc) ⭐ 774 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-19 - Complete solution for Micro Frontends composition into SPA with SSR support.
...
* [NUT](https://github.com/nut-project/nut) ⭐ 110 | 🐛 19 | 🌐 HTML | 📅 2026-07-21
...
* [Service Oriented Front-end](https://github.com/CanopyTax/sofe) ⭐ 138 | 🐛 5 | 🌐 JavaScript | 📅 2022-03-02
* [Micro-Frontends architecture](https://github.com/nuz-app/nuz/tree/next/docs) ⚠️ Archived
* [Angular\_MicroApps\_Different\_Technologies](https://github.com/manfredsteyer/Angular_MicroApps_Different_Technologies) ⭐ 54 | 🐛 30 | 🌐 CSS | 📅 2022-12-31
* [Exercises for course "Integrating microservices on the frontend"](https://github.com/0xR/micro-frontend) ⭐ 3 | 🐛 2 | 🌐 JavaScript | 📅 2016-09-05
* [Microservices in the frontend with BFFs providing their own bundles and API.](https://github.com/dactylographsy/browser-dactylographsy) ⭐ 3 | 🐛 1 | 🌐 JavaScript | 📅 2017-07-23
...
* [Elisabeth Engel (@\_lizzelo\_)](https://twitter.com/_lizzelo_)
...
* [Gustaf Nilsson Kotte (@gustaf\_nk)](https://twitter.com/gustaf_nk)
...
* [Module Federation](https://github.com/module-federation/module-federation-examples) ⭐ 6,145 | 🐛 51 | 🌐 JavaScript | 📅 2026-07-08
...
* [Sendo Farm](https://sendo.vn/sendofarm).
