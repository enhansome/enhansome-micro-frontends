...
* [Bit](https://github.com/teambit/bit) ⭐ 18,460 | 🐛 90 | 🌐 TypeScript | 📅 2026-08-25 - A tool for developing and composing / integrating independently versioned components.
* [Project Mosaic](https://www.mosaic9.org/) - A set of services, libraries together with a specification by Zalando.

### Frameworks

* [Garfish](https://github.com/modern-js-dev/garfish) ⭐ 2,909 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-21 - A powerful micro front-end framework.
...
* [Isomorphic Layout Composer](https://github.com/namecheap/ilc) ⭐ 774 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-25 - Complete solution for Micro Frontends composition into SPA with SSR support.
