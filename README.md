...
* [Bit](https://github.com/teambit/bit) ⭐ 18,475 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-09 - A tool for developing and composing / integrating independently versioned components.
* [Project Mosaic](https://www.mosaic9.org/) - A set of services, libraries together with a specification by Zalando.

### Frameworks

* [Garfish](https://github.com/modern-js-dev/garfish) ⭐ 2,910 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-08 - A powerful micro front-end framework.
...
* [OpenComponents, a framework for developing and distributing html components](https://github.com/opencomponents/oc) ⭐ 1,473 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-09
