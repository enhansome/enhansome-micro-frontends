...
* [Bit](https://github.com/teambit/bit) ⭐ 18,486 | 🐛 72 | 🌐 TypeScript | 📅 2026-09-18 - A tool for developing and composing / integrating independently versioned components.
* [Project Mosaic](https://www.mosaic9.org/) - A set of services, libraries together with a specification by Zalando.

### Frameworks

* [Garfish](https://github.com/modern-js-dev/garfish) ⭐ 2,912 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-17 - A powerful micro front-end framework.
...
* [NUT](https://github.com/nut-project/nut) ⭐ 110 | 🐛 27 | 🌐 HTML | 📅 2026-09-17
